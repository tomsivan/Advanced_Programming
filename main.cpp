    ...
    while (cont){
        ...
        switch (choise) {
            case 1:
                ...
                break;
            case 2:
                cout << "Capacity is: " << test->getCapacity() << endl;
                break;
            case 3:
...
int main(){
    ...
    PersonArray_t* arr = new PersonArray_t(2,4);
    PersonArray_t* arr2 = new PersonArray_t(2,2);
    ...
    arr2->insert(eliraz);
    cout<<"---------------------------------------------------------"<<endl;
    cout<< "arrayד suppose to be the same but with different capacity"<<endl;
    arr->printArr();
    arr2->printArr();
